...
public class BootIocProj03MiniProjectRealtimeDiApplication1 {

	public static void main(String[] args) {
		
		try(//get  access to IOC contaner
		ConfigurableApplicationContext ctx=SpringApplication.run(BootIocProj03MiniProjectRealtimeDiApplication1.class, args);
